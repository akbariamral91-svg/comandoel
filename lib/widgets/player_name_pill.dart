...
class _PlayerNamePillState extends State<PlayerNamePill>
  ...
  double get _avatarSize => widget.height * 0.82;
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        // عکس پروفایل بازیکن - دایره‌ای که بالای قرص اسم قرار می‌گیرد و کمی
        // روی آن overlap می‌کند (طبق طرح درخواستی).
        Positioned(
          top: -_avatarSize * 0.55,
          child: IgnorePointer(
            child: PlayerProfileAvatar(
              player: widget.player,
              size: _avatarSize,
              borderColor: widget.isSelected ? AppColors.brightGold : Colors.white,
              borderWidth: widget.isSelected ? 2.6 : 2.0,
            ),
          ),
        ),
